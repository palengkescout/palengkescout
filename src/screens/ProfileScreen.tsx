...
import { LogIn, LogOut, Trophy, Award, CircleCheck, CircleAlert, Clock } from "lucide-react";
...
export default function ProfileScreen() {
  ...
  useEffect(() => {
    ...
    (async () => {
      setLoading(true);
      const [total, reporterStats, profileRow] = await Promise.all([
